const setFairyDialogs = () => {
    dialogs.fairy = {
        0: () => {
            Swal.fire({
                ...
                if (result.value) {
                    Swal.fire({
                        title: 'Fairy:',
                        text: 'Long long ago, the princess of a kingdom was kidnapped ' +
                        ...
                        Swal.fire({
                            title: 'Fairy:',
                            text: 'Please feel free to press H for help at anytime. Have fun!',
                            imageUrl: './images/fairy.png',
                            imageWidth: 100,
                            imageHeight: 100
                        })
        ...
        1: () => {
            Swal.fire({
                title: 'Fairy:',
                text: `The keys can open the doors of corresponding colors, ` +
        ...
        2: () => {
            Swal.fire({
                title: 'Fairy:',
                text: `The Dictionary on the first floor is crucial for this game ` +
        ...
        3: () => {
            Swal.fire({
                title: 'Fairy:',
                text: `There are swords and shields in this tower. Try to find them first ` +
        ...
        4: () => {
            Swal.fire({
                title: 'Fairy:',
                text: `I heard the shield can be found on the 7th floor. ` +
        ...
        5: () => {
            Swal.fire({
                title: 'Fairy:',
                text: `There are traders in this tower and you can buy items from ` +
        ...
        7: () => {
            Swal.fire({
                title: 'Fairy:',
                text: `As you could see, some doors are sealed, like the one behind me. ` +
        ...
        8: () => {
            Swal.fire({
                title: 'Fairy:',
                text: `The Tower of Sorcerer is divided into zones. ` +
        ...
        9: () => {
            Swal.fire({
                title: 'Fairy:',
                text: `The Slimes are the weakest among the monsters. ` +
